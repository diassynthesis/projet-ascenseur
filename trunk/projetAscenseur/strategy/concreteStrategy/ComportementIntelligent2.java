...
public class ComportementIntelligent2 implements ComportementAbstrait{
    ...
    public void seDeplacer()
    {
        if((asc.isMonte())&&(!asc.isPortesOuvertes())) //si l'asc est en mode "monte"
        {
            ...
            {
		//Si qqun veut descendre ou si qqun veut entrer dans l'ascenseur (appel de fonction permet de faire la correspondance entre numéro d'étage et l'objet Etage)
