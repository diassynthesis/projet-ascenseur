...
public class Manager extends JFrame{
    ...
    public void initManager() throws MalformedURLException{
        ...
        jLabelEtage4.setText("...");

        jLabelConso4.setText("...");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtat4)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelEtat4))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtage4)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelEtage4))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabelLabConso4)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelConso4))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jButtonMaintenance4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonDemarrer4)))
        ...
        jLabelEtage1.setText("...");

        jLabelConso1.setText("...");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtat1)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelEtat1))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtage1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabelEtage1))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabelLabConso1)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelConso1))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jButtonMaintenance1)
                        .addGap(6, 6, 6)
                        .addComponent(jButtonDemarrer1)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabelEtage3.setText("...");

        jLabelConso3.setText("...");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtat3)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelEtat3))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabelLabConso3)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelConso3))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                .addComponent(jLabelLabEtage3)
                                .addGap(18, 18, 18)
                                .addComponent(jLabelEtage3))
                            .addComponent(jButtonMaintenance3, javax.swing.GroupLayout.Alignment.LEADING))
                        .addGap(6, 6, 6)
                        .addComponent(jButtonDemarrer3)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 22, Short.MAX_VALUE)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonMaintenance3)
                    .addComponent(jButtonDemarrer3))
                .addContainerGap())
        );
        ...
        jLabelEtage2.setText("...");

        jLabelConso2.setText("...");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtat2)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelEtat2))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtage2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabelEtage2))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabelLabConso2)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelConso2))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jButtonMaintenance2)
                        .addGap(6, 6, 6)
                        .addComponent(jButtonDemarrer2)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabelEtage5.setText("...");

        jLabelConso5.setText("...");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtat5)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelEtat5))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(jLabelLabConso5)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelConso5))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                                .addComponent(jLabelLabEtage5)
                                .addGap(27, 27, 27)
                                .addComponent(jLabelEtage5))
                            .addComponent(jButtonMaintenance5, javax.swing.GroupLayout.Alignment.LEADING))
                        .addGap(6, 6, 6)
                        .addComponent(jButtonDemarrer5)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 22, Short.MAX_VALUE)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonMaintenance5)
                    .addComponent(jButtonDemarrer5))
                .addContainerGap())
        );
        ...
        jLabelEtage6.setText("...");

        jLabelConso6.setText("...");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(jLabelLabEtat6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabelEtat6))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addComponent(jLabelLabEtage6)
                                .addGap(18, 18, 18)
                                .addComponent(jLabelEtage6))
                            .addComponent(jButtonMaintenance6)
                            .addComponent(jLabelLabConso6))
                        .addGap(6, 6, 6)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabelConso6)
                            .addComponent(jButtonDemarrer6))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jComboBoxPlugin, javax.swing.GroupLayout.Alignment.TRAILING, 0, 258, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(194, 194, 194)
                        .addComponent(jButtonMaintenanceGene, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonAlert, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButtonMaintenanceGene))
                .addContainerGap())
        );
    ...
    public void setNumEtage(int numAscenseur, int numEtage){
        Integer et = new Integer(numEtage);
                    System.out.println(numAscenseur);
